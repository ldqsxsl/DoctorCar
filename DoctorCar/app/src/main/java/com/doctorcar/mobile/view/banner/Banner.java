...
import com.doctorcar.mobile.module.main.activity.MainActivity;
...
import com.doctorcar.mobile.view.banner.loader.ImageLoaderInterface;
import com.doctorcar.mobile.view.banner.view.BannerViewPager;
...
//        rs = context.getApplicationContext().getResources();
//        rs = AppConfig.getResource();
//        dm = rs.getDisplayMetrics();
//        TLUtil.showToast(rs+"");
//        TLUtil.showToast(dm+"");

//        indicatorSize = ScreenUtils.getScreenW(context) / 80;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidth = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_banner_width, indicatorSize);
        mIndicatorHeight = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_banner_height, indicatorSize);
