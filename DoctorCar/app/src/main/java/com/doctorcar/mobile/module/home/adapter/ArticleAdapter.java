...
public class ArticleAdapter  extends RecyclerView.Adapter<ArticleAdapter.ViewHolder> {
    ...
    public ArticleAdapter(Context mContext, List<ProblemBean> mDatas) {
    ...
    public void setOnRecyclerViewListener(OnItemClickViewListener onRecyclerViewListener) {
        ArticleAdapter.onRecyclerViewListener = onRecyclerViewListener;
    }
    ...
    public ArticleAdapter setDatas(List<ProblemBean> datas) {
        mDatas = datas;
    ...
    public ArticleAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ArticleAdapter.ViewHolder(mInflater.inflate(R.layout.home_article_item, parent, false));
    }
