...
public class MineArticleAdapter extends RecyclerView.Adapter<MineArticleAdapter.ViewHolder>{
    ...
    public MineArticleAdapter(Context mContext, List<ArticleBean> mDatas) {
        this.mContext = mContext;
        this.mDatas = mDatas;
        mInflater = LayoutInflater.from(mContext);
    }

    public MineArticleAdapter setDatas(List<ArticleBean> datas) {
        mDatas = datas;
    ...
    public static void setOnRecyclerViewListener(OnItemClickViewListener onRecyclerViewListener) {
        MineArticleAdapter.onRecyclerViewListener = onRecyclerViewListener;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MineArticleAdapter.ViewHolder(mInflater.inflate(R.layout.mine_article_fg_item, parent, false));
    }
