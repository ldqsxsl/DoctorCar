...
public class LoginPresenter extends LoginContract.Presenter{
    ...
    public void getLoginRequest(String username, String password) {
        ...
        mRxManage.add(mModel.getLoginData(username,password).subscribe(new RxSubscriber<Result>(mContext) {
            @Override
            protected void _onNext(Result newsDetail) {
                mView.returnLoginData(newsDetail);
            }
