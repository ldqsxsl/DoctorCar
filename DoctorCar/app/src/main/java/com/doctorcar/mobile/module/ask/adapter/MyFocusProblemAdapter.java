...
public class MyFocusProblemAdapter  extends RecyclerView.Adapter<MyFocusProblemAdapter.ViewHolder> {
    ...
    public MyFocusProblemAdapter(Context mContext, List<ProblemBean> mDatas) {
    ...
    public static void setOnRecyclerViewListener(OnItemClickViewListener onRecyclerViewListener) {
        MyFocusProblemAdapter.onRecyclerViewListener = onRecyclerViewListener;
    }
    public MyFocusProblemAdapter setDatas(List<ProblemBean> datas) {
        mDatas = datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyFocusProblemAdapter.ViewHolder(mInflater.inflate(R.layout.my_focus_problem_item, parent, false));
    }
